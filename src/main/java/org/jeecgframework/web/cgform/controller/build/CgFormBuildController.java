...
//			String mode=request.getParameter("mode");
	        ...
	        if(StringUtils.isNotEmpty(id)){
	        	...
	        	ThreadContext.setDbSource(head.getDbSource());
...
//		sb.append("<script type=\"text/javascript\" src=\"plug-in/lhgDialog/lhgdialog.min.js\"></script>");
	...
	public AjaxJson doButton(HttpServletRequest request){
		...
		try {
			...
			CgFormHeadEntity tableEntity = tablePropertyService.findByProperty(CgFormHeadEntity.class, "tableName", tableName).get(0);
			
			
			ThreadContext.setDbSource(tableEntity.getDbSource());
